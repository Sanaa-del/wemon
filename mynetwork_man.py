...
if __name__ == '__main__':
    setLogLevel( 'info' )
    server_cpu_v = 0.5  # Example values for server CPU
    fading_v = 4  # Example values for fading
    delay_v = '400ms'  # Example values for delay
    loss_v =  20  # Example values for loss
    bw_v = 15  # Example values for bandwidth
    client_cpu_v = 1
